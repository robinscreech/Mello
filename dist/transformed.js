...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Card__ = __webpack_require__(29);
...
class App extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    componentDidMount() {
        ...
        __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this).addEventListener("click", this.handleEditCard);
    }

    componentWillUnmount() {
        __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this).removeEventListener("click", this.handleEditCard);
    }

    handleEditCard(event) {
        let i = 0;
        let cardElement = event.target.parentNode;
        while ((cardElement = cardElement.previousSibling) != null) i++;
        const cardData = this.state;
        let inputValue = cardData.data[i].content;
        cardData.data[i].content = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('textarea', { defaultValue: inputValue });
    ...
    render() {
        ...
        const cards = data.map(d => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Card__["a" /* default */], { id: d._id, key: d._id, title: d.title, content: d.content, isEdit: d.isEdit }));
...
class Card extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { className: 'card', key: 'this.props.key' },
